<template>
  <div class="music-container" @mouseover="hovering = true" @mouseleave="hovering = false">
    <div class="artwork-container">
      ...
      <img v-show="!loading" class="artwork" :src="song.thumbnails.reduce((prev, current) => (prev.width > current.width) ? prev : current).url" alt="Music Artwork" @error="loading = true" @load="loading = false">
